        ...
        <Dialog as="div" className="relative z-10" onClose={closeModal}>
          ...
          <div className="fixed inset-0 overflow-y-auto">
            <div className="flex min-h-full items-center justify-center p-4 text-center">
              ...
              >
                <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-modal-surface p-6 text-left align-middle shadow-xl transition-all">
                  <Dialog.Title
                    as="h3"
                    className="text-lg font-medium leading-6 text-modal"
                  >
                  ...
                  <div className="absolute top-3 right-3">
                    <button
                      ...
                      className="h-6 w-6"
                    >
                      <XOut className="text-modal-close" />
                    </button>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
